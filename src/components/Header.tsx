  ...
  return (
    <header className="sticky top-0 z-50 border-b bg-white/80 backdrop-blur">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid h-[72px] grid-cols-[1fr_auto_1fr] items-center">
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            {/* 모바일: 햄버거 버튼 (우측 끝) */}
            <button
              className="lg:hidden inline-flex items-center justify-center rounded-lg bg-gray-100 p-2 text-gray-700 transition-colors hover:bg-gray-200"
            ...
            >
              ...
              <span className="relative block h-6 w-6">
                <span className="absolute left-0 top-[6px] h-[2px] w-6 rounded-full bg-gray-700" />
                <span className="absolute left-0 top-[12px] h-[2px] w-6 rounded-full bg-gray-700" />
                <span className="absolute left-0 top-[18px] h-[2px] w-6 rounded-full bg-gray-700" />
              </span>
            </button>
          </div>
        </div>
      ...
      >
        ...
        <aside
          className={[
            "absolute right-0 top-0 h-full w-[78vw] max-w-[320px] bg-white shadow-xl",
              ...
              {items.map((it) => (
                ...
                >
                  <span className="inline-flex items-center gap-2">
                    <span className="h-1.5 w-1.5 rounded-full bg-transparent group-hover:bg-blue-600" />
                    {it.label}
                  </span>
                </NavLink>
              ))}
